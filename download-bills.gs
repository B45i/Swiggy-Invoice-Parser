function downloadAttachments() {
  ...
  var startDate = "2023-11-24"; // yyyy-mm-dd
  var endDate = "2023-12-20";

  var searchString = "in:spam from:" + targetEmail + " after:" + startDate + " before:" + endDate;
  
  console.log(searchString)
  var folder = DriveApp.createFolder(startDate + ' to ' + endDate);
    ...
    for (var j = 0; j < messages.length; j++) {
      ...
      if (message.getAttachments().length > 0) {
        ...
        for (var k = 0; k < attachments.length; k++) {
          ...
          console.log('adding..')
          //var folder = DriveApp.getFolderById("1G_lAzlUu0fV7SU_QOXPuFxB5geUeRaX6");
